//Written by Yongyu XU-6.16.2026.7PM
...
int motorSpeedLeft = 120;//initial speed
int motorSpeedRight = 110;//initial speed
int turnSpeedLeft = 60;//turning speed
int turnSpeedRight = 55;//turning speed
...
void loop() {
  ...
  if (leftIR == WHITE && rightIR == WHITE) {
    forward();//both white, move forward
    }
